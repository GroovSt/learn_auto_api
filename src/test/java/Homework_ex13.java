...
public class Homework_ex13 {
    ...
    public void testUserAgent(String userAgent, String platform, String browser, String device) {
        ...
        assertEquals(platform, responsePlatform, ("Error in platform for userAgent: " + userAgent));
        assertEquals(browser, responseBrowser, ("Error in browser at userAgent: " + userAgent));
        assertEquals(device, responseDevice, ("Error in device at userAgent: " + userAgent));
    }
}
